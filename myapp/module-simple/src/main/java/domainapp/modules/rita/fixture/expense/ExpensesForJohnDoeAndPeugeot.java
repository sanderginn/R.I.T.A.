...
public class ExpensesForJohnDoeAndPeugeot extends ExpenseAbstract {

    public static final BigDecimal COST_EXPENSE_ONE = BigDecimal.valueOf(25);
    public static final BigDecimal COST_EXPENSE_TWO = BigDecimal.valueOf(40);
    ...
    protected void execute(final ExecutionContext executionContext) {
        ...
        final Driver driver = driverRepository.findByLastName(DriverForJohnDoe.LAST_NAME).get(0);
